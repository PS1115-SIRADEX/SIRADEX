CREATE TABLE USUARIO(
	ci       	VARCHAR(10) NOT NULL, --OJO CAMBIAR CON TODODO
	nombres    	VARCHAR(50),
	apellido   	VARCHAR(50),
	password 	VARCHAR,
	telefono    VARCHAR(15),
...
CREATE TABLE USBID(
	...
	CONSTRAINT PK_USBID PRIMARY KEY (ci_usuario,usbid),
...
CREATE TABLE JEFE_DEPENDENCIA(
	...
	CONSTRAINT PK_JEFE_DEPENDENCIA PRIMARY KEY (id_jefe),
...
CREATE TABLE ACTIVIDAD(
	...
	estado 			  	VARCHAR,
	evaluacion_criterio VARCHAR(256), --CHECK
	evaluacion_valor	VARCHAR(256), --CHECK
...
CREATE TABLE PERMISOS_TIPO_ACT(
	permiso 	VARCHAR(256), -- CHECK
	id_tipo 	SERIAL,

	CONSTRAINT PK_PERMISOS_TIPO_ACT PRIMARY KEY (permiso,id_tipo),
...
CREATE TABLE CAMPO_CATALOGO(
	id_campo_cat		SERIAL,
	tipo_cat 			VARCHAR(256), --CHECK
	nombre 				VARCHAR(64),

	CONSTRAINT PK_CAMPO_CATALAGO PRIMARY KEY (id_campo_cat)
);
...
CREATE TABLE LOG(
	...
	CONSTRAINT PK_LOG PRIMARY KEY (accion,accion_fecha,accion_ip),
...
CREATE TABLE PARTICIPA_ACT(
	...
	CONSTRAINT PK_PARTICIPA_ACT PRIMARY KEY (ci_usuario,id_actividad),
...
CREATE TABLE TIENE_CAMPO(
	id_actividad 	INT,
	id_campo 		INT,
	valor_campo 	VARCHAR(256), --CHECK

	CONSTRAINT PK_TIENE_CAMPO PRIMARY KEY (id_actividad, id_campo),
...
CREATE TABLE ACT_POSEE_CAMPO(
	...
	CONSTRAINT PK_ACT_POSEE_CAMPO PRIMARY KEY (id_tipo_act,id_campo),
...
CREATE TABLE GESTIONA_TIPO_ACT(
	...
	CONSTRAINT PK_GESTIONA_TIPO_ACT PRIMARY KEY (id_jefe, id_tipo_act),
...
CREATE TABLE GESTIONA_CATALOGO(
	...
	CONSTRAINT PK_GESTIONA_CATALOGO PRIMARY KEY (id_jefe, id_catalogo),
...
CREATE TABLE CATALOGO_TIENE_CAMPO(
	...
	CONSTRAINT PK_CATALOGO_TIENE_CAMPO PRIMARY KEY (id_catalogo, id_campo_cat),
...
CREATE TABLE CATALOGO_CONTIENE_CAMPO(
	id_catalogo 	INT,
	id_campo_cat	INT,
	valor 			VARCHAR(256), --CHECK

	CONSTRAINT PK_CATALOGO_CONTIENE_CAMPO PRIMARY KEY (id_catalogo, id_campo_cat),
