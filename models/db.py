...
db.define_table('USUARIO',
    Field('ci',type='string',length=10, notnull=True,required=True, unique=True),
    Field('nombres',type='string',length=50,required=True),
    Field('apellido',type='string',length=50,required=True),
    Field('telefono',type='string',length=15,required=True),
    Field('email',type='string',length=50,required=True),
    Field('tipo',type='integer',length=15,required=True),
    primarykey=['ci'],
    migrate=False
);
...
db.define_table('TIPO_ACTIVIDAD',
    ...
    Field('tipo_p_r',type='string', length=1, notnull=True),
